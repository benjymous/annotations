...
Marlowe's play _Faustus_.  Note that Shakespeare speaks in iambic pentameter,
...
_The Desert Peach_ <plug> <plug>).  We get "straight" for heterosexuals in
...
Viktor Haag <vehaag@crocus.waterloo.edu>, he investigated the Wandering Jew.
...
Dream's choice of clothing.  William Sherman <sherman@math.ucla.edu> and
...
numbering.
        Michael Bowman <mbowman@andromeda.rutgers.edu> added some information
on `bent'.
	Mark MacBear <mamcconnell@uccs.edu> identifying Marlowe's role in
